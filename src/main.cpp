...
uint256 hashGenesisBlock("0xa5bbec6c3a959a53175fcfc21d081f1f2fc39a66fb225bdcac1e58902173173a");
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xdc92b692343d6cb3aea4b069c2bc1ddb4389c0aa81a1fb7e9612d2fea7494ec6");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04e5aa00a134cf0ba2635aff19792021abcfbf9ce6c87de55c1ce2a11158eff2d4695c041403da23635ededf919cb0706a47a404ea4453e0cd0cfc26cdb21e2bb0") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1574613267;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2085113050;

        if (fTestNet)
        {
            block.nTime    = 1574613251;
            block.nNonce   = 385904109;
        }
...
if (false && block.GetHash() != hashGenesisBlock)
        ...
        assert(block.hashMerkleRoot == uint256("0x86fbc1fee91bad3e00c3a697f289adeade7a3215a0e9068a2ce61b0f9face887"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xf3, 0xc4, 0xbc, 0xde }; // Jppoints: increase each by adding 2 to bitcoin's value.
